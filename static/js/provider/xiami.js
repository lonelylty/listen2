var xiami = (function() {
    ...
    var xm_show_playlist = function(url, hm) {
        ...
        return {
            success: function(fn) {
                var result = [];
                target_url="/index?domain=xiami&url="+encodeURIComponent(target_url);
    ...
    var xm_get_playlist = function(url, hm, se) {
        ...
        return {
            success: function(fn) {
                ...
                hm({
                    url:"/index?domain=xiami&url="+encodeURIComponent(target_url),
                    method: 'GET',
        ...
        return {
            success: function(fn) {
                ...
                .success(function(data) {   
                    ...
                    hm({
                        url:"/index?domain=xiami&url="+target_url,
                        method: 'GET',
                        transformResponse: undefined
                    })
                    .success(function(data) {
    ...
    var xm_lyric = function (url, hm, se) {
        ...
        return {
            success: function(fn) {
                hm({
                    url: "/index?domain=xiami&url="+encodeURIComponent(lyric_url),
                    method: 'GET',
                    transformResponse: undefined
                }).success(function(data) {
